...
class TestGeoModelR(unittest.TestCase):
    def test_create_model(self):
        pass
    def test_fault_plane_for_lines(self):
        """
        ...
        self.assertEqual(faults.fault_plane_for_lines(la, lb), [(0, 1, 4), (1, 4, 5), (1, 2, 5), (2, 3, 5), (3, 5, 6), (3, 6, 7)])
        ...
        with self.assertRaises(shared.GeometryException):
            faults.fault_plane_for_lines(la, lb)
        la = [(-1, 2,0), (-2,1, 0), (-2,-1,0), (-1,-2,0), (1,-2,0), (2,-1,0), (2, 1,0), (1,2,0)]
        ...
        la = [(-1,-2,0), (-2,-1,0), (-2,1,0),  (-1, 2,0), (1, 2,0), (2, 1,0), (2,-1,0), (1, -2, 0)]
        lb = [(-1, 2, 1), (-2, 3, 1), (-2, 5, 1), (-1, 6, 1), (1, 6, 1), (2, 5, 1), (2, 3, 1), (1, 2, 1)]
        self.assertEqual(faults.fault_plane_for_lines(la, lb), [(0,1,  8), (1,  8,  9), (1,  2,  9), 
